...
INSERT INTO products (category_id, name, description, price, image_url, features, stock) VALUES
    (
        ...
        125000,
        '/assets/images/balines dorados.jpeg',
    ...
    (
        ...
        165000,
        '/assets/images/van cleef dorada.jpeg',
    ...
    (
        ...
        150000,
        '/assets/images/van cleef negra.jpeg',
    ...
    (
        ...
        150000,
        '/assets/images/van cleef roja.jpeg',
    ...
    (
        ...
        50000,
        '/assets/images/AnilloDiseñoExclusivo.jpg',
    ...
    (
        ...
        75000,
        '/assets/images/AnilloTresCarriles.jpg',
    ...
    (
        ...
        50000,
        '/assets/images/AnilloTresCarrilesLiso.jpg',
    ...
    (
        ...
        120000,
        '/assets/images/Manilla7BalinesDiamantada.jpg',
    ...
    (
        ...
        'Edición limitada con diseño exclusivo y detalles en balinería de alta calidad. La pieza perfecta para hacer una declaración de estilo.',
        120000,
        '/assets/images/ManillaBolsaDinero.jpg',
        '["Material: Acero quirúrgico premium","Longitud: 45 cm con extensión de 5 cm","Dije: Diseño exclusivo en balinería","Cierre: Seguro de doble bloqueo","Incluye: Certificado de autenticidad"]'::jsonb,
        10
    ),
    (
        ...
        'Edición limitada con diseño exclusivo y detalles en balinería de alta calidad. La pieza perfecta para hacer una declaración de estilo.',
        120000,
        '/assets/images/ManillaDiamantadaCentro.jpg',
        '["Material: Acero quirúrgico premium","Longitud: 45 cm con extensión de 5 cm","Dije: Diseño exclusivo en balinería","Cierre: Seguro de doble bloqueo","Incluye: Certificado de autenticidad"]'::jsonb,
        10
    ),
    (
        ...
        'Edición limitada con diseño exclusivo y detalles en balinería de alta calidad. La pieza perfecta para hacer una declaración de estilo.',
        150000,
        '/assets/images/ManillaDollar.jpg',
        '["Material: Acero quirúrgico premium","Longitud: 45 cm con extensión de 5 cm","Dije: Diseño exclusivo en balinería","Cierre: Seguro de doble bloqueo","Incluye: Certificado de autenticidad"]'::jsonb,
        7
    ),
    (
        ...
        'Edición limitada con diseño exclusivo y detalles en balinería de alta calidad. La pieza perfecta para hacer una declaración de estilo.',
        115000,
        '/assets/images/ManillaFullBalinLiso.jpg',
        '["Material: Acero quirúrgico premium","Longitud: 45 cm con extensión de 5 cm","Dije: Diseño exclusivo en balinería","Cierre: Seguro de doble bloqueo","Incluye: Certificado de autenticidad"]'::jsonb,
        12
    );
